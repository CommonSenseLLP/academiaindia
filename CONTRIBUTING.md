...
157 tests pass + 10 deliberate skips at the time of writing; new
...
### 2026-05-13 — Test counts refreshed; docs sync added

The numbers in the 2026-05-06 entry above are superseded:

- **Python (`make test`)**: 157 tests pass + 10 deliberate skips (was 153).
